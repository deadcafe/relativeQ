...
- Misses are inserted inline during cmp_key using the hash already
  computed in the pipeline (no rehash, buckets warm in L1), with
  local pressure relief when the candidate bucket is dense
