...
#define RIX_RB_PROTOTYPE(name, type, field, cmp)                               \
    type *name##_RIX_RB_INSERT(struct name *head, type *base, type *elm);      \
    type *name##_RIX_RB_REMOVE(struct name *head, type *base, type *elm);      \
    type *name##_RIX_RB_FIND(struct name *head, type *base, const type *key);  \
    type *name##_RIX_RB_NFIND(struct name *head, type *base, const type *key); \
    type *name##_RIX_RB_MINMAX(struct name *head, type *base, int dir);        \
    type *name##_RIX_RB_NEXT(type *base, type *elm);                           \
    type *name##_RIX_RB_PREV(type *base, type *elm);
